...
const handleTranslate = () => {
    // 1. დავამატოთ შემოწმება sourceLang-ზე
    ...
    // 2. ამ ხაზზე შეცდომა აღარ იქნება
    // Define LangCode type locally if not exported from dataService
    type LangCode = 'ka' | 'en';
    const results = dataService.findAllTranslations(inputText.trim(), sourceLang as LangCode);
